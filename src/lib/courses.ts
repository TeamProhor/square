...
export const COURSES: readonly Course[] = [
  {
    ...
    subtitle:
      "ফিজিক্স, কেমিস্ট্রি, ম্যাথ ও বায়োলজির এ টু জেড পূর্ণাঙ্গ একাডেমিক ও অ্যাডমিশন ফাউন্ডেশন",
    description:
  ...
  },
  {
    ...
    subtitle:
      "পদার্থবিজ্ঞান ১ম ও ২য় পত্রের জটিল গাণিতিক সমস্যার নিখুঁত সমাধান ও থিওরি ক্লিয়ারিং",
    description:
  ...
  },
  {
    ...
    subtitle:
      "ক্যালকুলাস, ত্রিকোণমিতি, সরলরেখা ও বৃত্তের টাইপভিত্তিক শর্টকাট ও প্রুফ মাস্টারক্লাস",
    description:
  ...
  },
  {
    ...
    subtitle:
      "বোর্ড ও প্রি-টেস্ট স্ট্যান্ডার্ড ৩০+ পেপার ফাইনাল, বিষয়ভিত্তিক ও পূর্ণাঙ্গ মডেল টেস্ট",
    description:
