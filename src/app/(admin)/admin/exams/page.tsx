    ...
    <div className="flex flex-col w-full max-w-7xl mx-auto pb-12 pt-2 md:py-8 gap-8">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            সব ধরনের পরীক্ষা পরিচালনা ও তৈরি করুন
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        {exams?.map((exam) => (
          <div
            key={exam.id}
            className="border rounded-xl p-5 bg-card hover:border-primary/50 transition-all flex flex-col gap-4 shadow-sm"
          >
            <div>
              ...
              <div className="flex items-center gap-2 mt-2">
                ...
                <span
                  className={`px-2 py-0.5 rounded-full text-[10px] font-medium ${exam.isPublished ? "bg-emerald-500/10 text-emerald-600" : "bg-amber-500/10 text-amber-600"}`}
                >
