...
import {
  Flash as CursorClickIcon,
  Language as GlobeIcon,
  StatusUp as TrendUpIcon,
  ...
  return (
    <>
      ...
      <div className="relative mt-8 space-y-1.5 text-center">
        <FeatureTitle className="font-extrabold text-base sm:text-lg">
          ২ মিনিটে প্রস্তুতি শুরু
        </FeatureTitle>
        <FeatureDescription className="text-xs sm:text-sm">
          অ্যাকাউন্ট খুলে তাৎক্ষণিকভাবে ফ্রি প্রশ্নব্যাংক ও প্র্যাকটিস শুরু করো।
        </FeatureDescription>
      </div>
    </>
  );
...
function UserBasedSecurity() {
  return (
    <>
      ...
      <div className="relative mt-8 space-y-1.5 text-center">
        <FeatureTitle className="font-extrabold text-base sm:text-lg">
          নিরাপদ ও ব্যক্তিগত পোর্টাল
        </FeatureTitle>
        <FeatureDescription className="text-xs sm:text-sm">
          তোমার প্রগ্রেস, বুকমার্কস এবং এক্সাম রেজাল্ট সবসময় সংরক্ষিত।
        </FeatureDescription>
      </div>
    </>
  );
    ...
    <>
      <div className="min-h-32">
        <div className="absolute top-8 left-8 flex items-center gap-2">
          ...
          <div className="font-bold text-foreground">৯৮.৫%</div>
        </div>
        <ReportsChartsSvg className="translate-x-[5%] -rotate-2 scale-150" />
      </div>
      <div className="relative z-10 mt-8 space-y-1.5 text-center">
        <FeatureTitle className="font-extrabold text-base sm:text-lg">
          পারফর্মেন্স ও অ্যানালাইটিক্স
        </FeatureTitle>
        <FeatureDescription className="text-xs sm:text-sm">
          প্রতিটি এক্সামের নির্ভুল মূল্যায়ন ও দুর্বল চ্যাপ্টার চিহ্নিত করার সুবিধা।
        </FeatureDescription>
      </div>
    </>
  );
    ...
    <div className="grid h-full sm:grid-cols-2">
      <div className="relative z-10 space-y-6 py-8 ps-8 pe-2">
        <div className="flex size-12 items-center justify-center rounded-full border bg-card shadow-xs outline outline-border/80 outline-offset-2">
          <CursorClickIcon className="size-5 text-primary/80" />
        </div>
        <div className="space-y-2">
          <FeatureTitle className="font-extrabold text-base">
...
function PresenceVisual() {
  return (
    <div className="grid h-full sm:grid-cols-2 items-center">
      <div className="space-y-6 py-8 pl-8 pr-4">
        <div className="flex size-12 items-center justify-center rounded-full border bg-card shadow-xs outline outline-border/80 outline-offset-2">
        ...
        <div className="space-y-2">
          ...
          <FeatureDescription className="text-xs sm:text-sm">
            মোবাইল, ট্যাবলেট বা ল্যাপটপ — যেকোনো স্থান থেকে সহজে ক্লাস ও পরীক্ষা দাও।
          </FeatureDescription>
        </div>
      </div>
      <div className="relative flex items-center justify-center p-4 min-h-[220px]">
        <CobeGlobe className="w-full max-w-[280px]" />
      </div>
    </div>
  );
}
